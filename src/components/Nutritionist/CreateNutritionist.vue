    ...
    <v-card  class="d-flex flex-column  align-center space-evenly elevation-10 mt-10 mt-sm-0 mx-auto my-auto">
      ...
      <v-form v-model="valid" class="form-container">
        <v-container class="d-flex flex-column">
          <v-text-field v-model="username" label="Username" placeholder="Ex.JhonSilva231" required outlined></v-text-field>
          ...
          <v-text-field v-model="firstName" label="FirstName" placeholder="Ex.Jhon" required outlined></v-text-field>
          <v-text-field  v-model="lastName" label="LastName" placeholder="Ex.Silva" required outlined></v-text-field>
          <v-text-field v-model="email" label="Email" placeholder="Ex.JhonSilva231@gmail.com" required  outlined></v-text-field>
           <v-text-field v-model="cnpNumber" label="CnpNumber" placeholder="5679584017" required  outlined></v-text-field>
